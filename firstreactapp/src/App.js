  ...
  return (
    <Container className="App">
      ...
      <SelectedBeast variable = {currentSelectedBeast} //Passes variable as a prop to the SelectedBeast component, variable is the value of currentSelectedBeast state variable
       variableTwo = {setCurrentSelectedBeast}// Passes variableTwo as a prop to the SelectedBeast component, variableTwo is a function to update the currentSelectedBeast state variable
       />:<></>} 
    </Container>
  );
}
